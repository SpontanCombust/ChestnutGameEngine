...
namespace chestnut
{
     ...
     * 
     * @details
     * A class housing parallel arrays (vectors) of component pointers. A batch is created for a specified component bundle signature. 
     * A class created from need of storing unspecified number of components of unspecified number of types. 
     * Allows for convenient access to components that belong to an entity with specific bundle of components, 
     ...
     * You may submit component by passing a component bundle with corresponding signature. 
     * You may get component pointers in form of a vector for specified component type. 
     */
    class CComponentBatch
    {
    private:
        SComponentBundleSignature m_signature;
    ...
    public:
        ...
        CComponentBatch( const SComponentBundleSignature& signature );

        ~CComponentBatch();


        void setSignature( const SComponentBundleSignature& signature );

        const SComponentBundleSignature& getSignature() const;
        ...
        void submitBundle( const SComponentBundle& bundle );
