...
namespace chestnut
{
    ...
    template
    Vector<float,3> operator-( const Vector<float,3>& v );
    ...
    template
    Vector<float,3> operator*( float s, const Vector<float,3>& v );

    template
    Vector<float,3> operator*( const Vector<float,3>& v, float s );
